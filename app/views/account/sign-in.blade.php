...
<div class="middle-box text-center loginscreen animated fadeInDown" style="vertical-align: middle">
    <div style="vertical-align: middle">
        ...
        <a class="btn btn-sm btn-white btn-block" style="background-color: #cccccc; color: #000000" href="register.html">Create an account</a>
        {{Form::close()}}
        <p class="m-t">
            <small> Copyright &copy; 2016 Exotic Holidays International Pvt (Ltd) All rights reserved..</small>
        </p>
    </div>
</div>
